...
Page({
  ...
  showStlist(name, sfsx) {
    ...
    let that = this;
    wx.request({
      url: app.httpUrl + '/yysXcxUserCenter/getHiscdList.x', // 该url是自己的服务地址，实现的功能是服务端拿到authcode去开放平台进行token验证
      data: {
  ...
  goDetail(e) {
    ...
    wx.navigateTo({ url: '../cdxq/cdxq?type=his&id=' + e.currentTarget.dataset.paramid });
  },
